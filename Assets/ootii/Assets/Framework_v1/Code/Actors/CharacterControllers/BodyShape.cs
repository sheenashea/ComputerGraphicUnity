...
namespace com.ootii.Actors
{
    ...
    public abstract class BodyShape
    {
        ...
        /// <summary>
        /// Checks the type of the prefab asset to determine if we can create the Unity colliders.
        /// </summary>
        /// <returns></returns>
        protected virtual bool CanCreateUnityColliders()
        {
            ...
            // Don't allow creating colliders on pre-2018.3 style prefabs
            PrefabType lPrefabType = PrefabUtility.GetPrefabType(_Parent.gameObject);
            if (lPrefabType == PrefabType.Prefab || lPrefabType == PrefabType.ModelPrefab) { return false ; }

            UnityEngine.Object lPrefabParent = PrefabUtility.GetPrefabParent(_Parent.gameObject);
            UnityEngine.Object lPrefabObject = PrefabUtility.GetPrefabObject(_Parent.gameObject);

            if (lPrefabParent == null && lPrefabObject != null) { return false; }
#endif
            return true;
        }
        ...
        {            
            ...
            foreach (PropertyInfo lProperty in lProperties)
            {
                ...
                {
                    lStringBuilder.Append(", \"" + lProperty.Name + "\" : \"" + ((float)lValue).Serialize() + "\"");
                }
